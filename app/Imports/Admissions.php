    ...
    public function model(array $row)
    {
        ...
        if($dataExport[0] != null){
            $dataPost = (object) array(
                ...
                'chuctrach'    =>  $dataExport[2] != null ? $dataExport[2] : "",
                'thoihan'    =>  $dataExport[3] != null ? $dataExport[3] : "",
                'noibanhanh'    =>  $dataExport[4] != null ? $dataExport[4] : "",
                'ngaycohieul'    =>  $dataExport[5] != null ? $dataExport[5] : "",
