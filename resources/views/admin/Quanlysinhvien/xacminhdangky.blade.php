    ...
    <div class="modal fade" id="modalDetail" tabindex="-1" aria-labelledby="modalDetailLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form action="{{ route('admin.quanlysinhvien.confirmStudent') }}" method="post">
                    @csrf
                    <input type="hidden" value="" id="input_confirm" name="id_confirm">
...
@section('footer_scripts')
    ...
    <script>
        let table = new DataTable('#myTable', {
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('admin.quanlysinhvien.listRegisterStudent') !!}',
            order:[],
            columns: [
                {
                    data: 'DT_RowIndex',
