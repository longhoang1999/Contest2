...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    <script>
        function showAlert(message, type = 'success') {
            const alertContainer = document.getElementById('kt_app_main');

            // Chèn HTML vào đầu thẻ alertContainer
            alertContainer.insertAdjacentHTML('afterbegin', `<div class="ps-4 pe-4">
